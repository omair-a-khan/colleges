...
##### https://www.diffchecker.com/m5plt7cm
##### SHOW TRUE RANKINGS (OF DTE) VS PREDICTED RANKINGS (TOP 50)
##### COMPARE my rankings to published rankings on ROI [roi doesn't have to be money, it could be prestige, networking, etc---look up how published rankings categorize ranking]
#university to university can be a treacherous endeavor
# acknowledge that you're doing a narrow thing (acknowledge the messiness of the data), what you can't do, what this won't do, and how the data undermines what i want to do, and then say what you CAN do [build trust]
